...
| Plugin version | v4.1.x | 3.0.2 / 3.1.0 | **4.4.0** ✅ | `.claude-plugin/plugin.json` (v4.2.0 Slice 1 → v4.2.1 SEC patch → v4.3.0 skill migration → v4.3.1 review polish → v4.4.0 Slice 1.5 entrega) |
...
| **1.5 — Pulsar bugfix workflow import** | (não previsto) | — | 🟢 **ENTREGUE em v4.4.0 (2026-05-01)** — ver consolidated §21. 4 commits (`a56b41c` light skill, `c2b18e1` heavy skill, `7272ff1` integration, + Phase 5/6 docs+manifests). 23 arquivos novos shippados (2 skills + 19 steps + 2 tests) + 8 regras enforcement + 6 gaps fechados (Heavy 3+9+11, Light 3+5+6). |
