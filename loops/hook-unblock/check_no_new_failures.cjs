#!/usr/bin/env node
// Contrapressão do loop hook-unblock: roda a suíte oficial do plugin e falha
// SOMENTE quando aparece falha NOVA em relação ao baseline registrado no intake
// (2026-07-07). Falhas pré-existentes (Langfuse/env, score-writer, F4 v8.8.0
// dispatch-pending fail-closed, v8.21.0 F1-F3 RED congelados da fatia S2) NÃO
// derrubam o loop; qualquer suíte fora dessa lista derrubando = regressão.
