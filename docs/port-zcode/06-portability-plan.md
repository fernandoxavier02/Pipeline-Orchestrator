...
rm -rf .pipeline .pipeline-orchestrator .pipeline-backup-* .remember .codex .cursor-plugin .opencode .githubcopilot BPOPrincing*.bundle
...
3. Aponte para o diretório deste port (o que contém .zcode-plugin/).
