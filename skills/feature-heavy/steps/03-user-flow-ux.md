...
source: "Pulsar/HEAVY_03_03_USER_FLOW_UX.md"
description: "Heavy 03: Fluxo do usuario e UX mobile-first"
...
Voce e meu arquiteto/engenheiro senior. Faca uma analise profunda focada em "Fluxo do usuario e UX (mobile-first quando aplicavel)", mantendo governanca e impacto minimo.
...
1) Analise "Fluxo do usuario e UX (mobile-first quando aplicavel)" em detalhe, apontando decisoes tecnicas e riscos.
