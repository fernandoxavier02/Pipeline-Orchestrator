...
description: |
  ...
  importados de Pulsar Implement_new_feature/Heavy/ — versão completa.
...
# Feature Pipeline Skill (Heavy)

13 passos canônicos espelhando 1:1 a fonte Pulsar `D:\Projeto Pulsar\.claude\commands\Prompts\Implement_new_feature\Heavy\`.
...
`references/pipelines/feature-heavy.md` lista team composition + step ordering. Tests em `tests/tests-feature-heavy.md`.
