> **DEPRECATED (as of v4.7.0):** This file is preserved as historical reference. New canonical entry-points: `/pipeline-orchestrator:feature-heavy` skill (`skills/feature-heavy/SKILL.md`) mirroring Pulsar workflow 1:1, or `/pipeline-orchestrator:feature` thin shortcut with `--heavy` flag. Variant id renamed to feature-heavy in v7.11.0 (AUDIT-013); canonical team-composition reference now lives in references/pipelines/feature-heavy.md. This alias file is kept for backward compatibility with historical run docs.
