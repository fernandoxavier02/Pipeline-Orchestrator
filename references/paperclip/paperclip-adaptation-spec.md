...
**Versao:** 0.1 — 2026-05-22
**Status:** template inicial, pendente piloto
**Aplica-se a:** todos os 46 cargos da empresa Paperclip "Pipeline Orchestrator"

---

## 1. Por que essa spec existe

Os 46 agentes originais do pipeline-orchestrator foram desenhados para o **harness do Claude Code**:
...
Sem traducao explicita, os 46 cargos vao improvisar comportamentos que parecem certos mas nao respeitam os contratos rigorosos do pipeline original. Esta spec define a traducao.
...
- [ ] Como sincronizar mudancas? (Se editamos o template, todos os 46 cargos precisam ser re-injetados)
