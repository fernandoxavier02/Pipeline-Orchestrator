...
const ALLOWED_GATE_DECISION_KEYS = Object.freeze([
  // Original 8 fields (v6.0.0+)
  'gate', 'hardness', 'phase', 'decision', 'decided_by',
  'timestamp', 'detail', 'confidence_impact',
  // Correlation envelope added in v7.1.0 (injected by gate-decision-writer.cjs).
  // Allows aggregate analytics across runs without requiring folder-path joins.
