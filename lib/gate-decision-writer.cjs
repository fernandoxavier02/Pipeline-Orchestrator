...
// v8.20.0-glm port: Langfuse foi removido; carrier require é fail-open.
// Quando o módulo não existe, readTraceCarrierForCurrentProcess retorna null
// e o bloco try-catch em appendGateDecision() simplesmente não executa o mirror.
...
try {
  ...
  // Langfuse removido neste port — telemetria desligada, funcionalidade core intacta.
}
